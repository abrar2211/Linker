...
<body>
    ...
    <header>
        ...
        <!--<div class="right_area">
            <a href="../Home/Home.html" class="logout_btn">Logout</a>
        </div>-->

    </header>
    <div class="sidebar">
        <a href="localhost/Myprofile/myprofile.html"><i class="far fa-user-circle"></i><span>My Profile</span></a>
        <a href=""><i class="fas fa-newspaper"></i><span>Newsfeed</span></a>
        <a href="http://localhost/Friend%20System/friends.php"><i class="fas fa-users"></i><span>Friends</span></a>
        <a href="#"><i class="far fa-comment-alt"></i><span>Messages</span></a>
        <a href="../Settings/Settings.html"><i class="fas fa-cog"></i><span>Settings</span></a>
    </div>
